        ...
        <div>
          ...
          <div ref={statsRef} className="mt-14 flex flex-wrap gap-10 md:gap-14">
            <div>
              ...
              <p className="mt-2 text-[10px] uppercase tracking-[0.25em] text-[#f5f2ed]/35">{t("about", "statFounded")}</p>
            </div>
            <div className="w-px self-stretch bg-[#f5f2ed]/10" />
            <div>
              <p className="text-4xl md:text-5xl font-black text-[#c9a96e] font-latin">4+</p>
              <p className="mt-2 text-[10px] uppercase tracking-[0.25em] text-[#f5f2ed]/35">{t("about", "statServices")}</p>
            </div>
            <div className="w-px self-stretch bg-[#f5f2ed]/10" />
            <div>
              <p className="text-4xl md:text-5xl font-black text-[#c9a96e] font-latin">KSA</p>
              <p className="mt-2 text-[10px] uppercase tracking-[0.25em] text-[#f5f2ed]/35">{t("about", "statBase")}</p>
            </div>
          </div>
        </div>

        <div className="lg:pt-6">
          <p ref={bodyRef} className="text-lg md:text-xl text-[#f5f2ed]/60 leading-[1.95] max-w-xl">
            {t("about", "body")}
          </p>
